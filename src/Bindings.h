...
inline Key normalizeModifierKey(Key k)
{
    switch (k) {
        case Key_Shift_L:
        case Key_Shift_R: return Key_Shift;
        case Key_Control_L:
        case Key_Control_R: return Key_Control;
        case Key_Alt_L:
        case Key_Alt_R: return Key_Alt;
        case Key_Super_L:
        case Key_Super_R: return Key_Meta;
        default: return k;
    }
}
...
{
    if (auto *a = std::get_if<Action::Any>(&r)) {
        return Action::typeOf(*a);
    }
