...
static std::string lineText(int i)
{
...
TEST_CASE("scrollback: width-change reflow leaves scrollback content intact" * doctest::test_suite("archive"))
{
    TestTerminal t(20, 5);
    t.term.resetScrollback(20);
...
TEST_CASE("scrollback: width-change reflow preserves locatable content" * doctest::test_suite("archive"))
{
    TestTerminal t(20, 5);
    t.term.resetScrollback(20);
...
TEST_CASE("scrollback: width-change reflow keeps line IDs monotonic" * doctest::test_suite("archive"))
{
    TestTerminal t(20, 5);
    t.term.resetScrollback(20);
