...
inline constexpr uint32_t sextantMask(uint32_t offset)
{
    ...
    if (mask >= 21) {
        mask++; // skip 21 (left half = 0b010101)
    }
    if (mask >= 42) {
        mask++; // skip 42 (right half = 0b101010)
    }
...
inline constexpr uint32_t kTable[kTableSize] = {
    ...
    PG_SEXTANT(sextantMask(0)),
    PG_SEXTANT(sextantMask(1)),
    PG_SEXTANT(sextantMask(2)),
    PG_SEXTANT(sextantMask(3)),
    PG_SEXTANT(sextantMask(4)),
    PG_SEXTANT(sextantMask(5)),
    PG_SEXTANT(sextantMask(6)),
    PG_SEXTANT(sextantMask(7)),
    PG_SEXTANT(sextantMask(8)),
    PG_SEXTANT(sextantMask(9)),
    PG_SEXTANT(sextantMask(10)),
    PG_SEXTANT(sextantMask(11)),
    PG_SEXTANT(sextantMask(12)),
    PG_SEXTANT(sextantMask(13)),
    PG_SEXTANT(sextantMask(14)),
    PG_SEXTANT(sextantMask(15)),
    PG_SEXTANT(sextantMask(16)),
    PG_SEXTANT(sextantMask(17)),
    PG_SEXTANT(sextantMask(18)),
    PG_SEXTANT(sextantMask(19)),
    PG_SEXTANT(sextantMask(20)),
    PG_SEXTANT(sextantMask(21)),
    PG_SEXTANT(sextantMask(22)),
    PG_SEXTANT(sextantMask(23)),
    PG_SEXTANT(sextantMask(24)),
    PG_SEXTANT(sextantMask(25)),
    PG_SEXTANT(sextantMask(26)),
    PG_SEXTANT(sextantMask(27)),
    PG_SEXTANT(sextantMask(28)),
    PG_SEXTANT(sextantMask(29)),
    PG_SEXTANT(sextantMask(30)),
    PG_SEXTANT(sextantMask(31)),
    PG_SEXTANT(sextantMask(32)),
    PG_SEXTANT(sextantMask(33)),
    PG_SEXTANT(sextantMask(34)),
    PG_SEXTANT(sextantMask(35)),
    PG_SEXTANT(sextantMask(36)),
    PG_SEXTANT(sextantMask(37)),
    PG_SEXTANT(sextantMask(38)),
    PG_SEXTANT(sextantMask(39)),
    PG_SEXTANT(sextantMask(40)),
    PG_SEXTANT(sextantMask(41)),
    PG_SEXTANT(sextantMask(42)),
    PG_SEXTANT(sextantMask(43)),
    PG_SEXTANT(sextantMask(44)),
    PG_SEXTANT(sextantMask(45)),
    PG_SEXTANT(sextantMask(46)),
    PG_SEXTANT(sextantMask(47)),
    PG_SEXTANT(sextantMask(48)),
    PG_SEXTANT(sextantMask(49)),
    PG_SEXTANT(sextantMask(50)),
    PG_SEXTANT(sextantMask(51)),
    PG_SEXTANT(sextantMask(52)),
    PG_SEXTANT(sextantMask(53)),
    PG_SEXTANT(sextantMask(54)),
    PG_SEXTANT(sextantMask(55)),
    PG_SEXTANT(sextantMask(56)),
    PG_SEXTANT(sextantMask(57)),
    PG_SEXTANT(sextantMask(58)),
    PG_SEXTANT(sextantMask(59)),
