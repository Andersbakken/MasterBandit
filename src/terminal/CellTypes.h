...
struct CellAttrs
{
    ...
    uint32_t packFgAsU32() const
    {
        ...
        return (static_cast<uint32_t>(data[0])) | (static_cast<uint32_t>(data[1]) << 8) | (static_cast<uint32_t>(data[2]) << 16) | 0xFF000000u;
    }
    ...
    uint32_t packBgAsU32() const
    {
        ...
        return (static_cast<uint32_t>(data[3])) | (static_cast<uint32_t>(data[4]) << 8) | (static_cast<uint32_t>(data[5]) << 16) | 0xFF000000u;
    }
